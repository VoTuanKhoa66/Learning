...
class ProductDetailAPIView(views.APIView):
    ...
    def get_object(self,id_slug):
        try:
            return Product.objects.get(pk=id_slug)
        except:
            raise Http404
    ...
    def delete(self, request, id_slug):
        try:
            product = self.get_object(id_slug)
            product.delete()
            return custom_response('Delete product successfully!', 'Success', {'product_id':id_slug}, 200)
        except:
...
class ProductImageAPIView(views.APIView):
    ...
    def get(self, request, product_id_slug):
        try:
            product_image = ProductImage.objects.filter(product_id=product_id_slug).all()
...
class ProductImageDetailAPIView(views.APIView):
    ...
    def get(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response('Get product image failed!', 'Error', 'Product image not found!', 200)
    ...
    def put(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response('Update product image failed!', 'Error', 'Product image not found!', 200)

    def delete(self, request, product_id_slug, id_slug):
        try:
            product_image = self.get_object_with_product_id(product_id_slug, id_slug)
            product_image.delete()
            return custom_response('Delete product image successfully!', 'Success', {'product_id_image':id_slug}, 204)
        except:
            return custom_response('Delete product image failed!', 'Error', 'Product image not found!', 200)
...
class ProductCommentAPIView(views.APIView):
    def get(self, request, product_id_slug):
        try:
            ...
            return custom_response('Get all product comments successfully!', 'Success', serializer.data, 200)
        except:
            return custom_response('Get all product comments failed!', 'Error', None, 200)
...
class ProductCommentDetailAPIView(views.APIView):
    ...
    def put(self, request, product_id_slug, id_slug):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return custom_response('Update product commemt successfully!', 'Success', serializer.data, 200)
            else:
    ...
    def delete(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response('Delete product comment successfully!', 'Success', {'product_id': id_slug}, 200)
        except:
            return custom_response('Delete product comment failded!', 'Error', 'Product comment not found!', 400)
